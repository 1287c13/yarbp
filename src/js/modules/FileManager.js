  ...
  событие = e1 .х 241 .у 534
    шлюз = g1 .х 335 .у 527 .х-закр 1275 .у-закр 527
      ...
      ветка = +
        ...
        подпроцесс = s1 .повторение параллель .х 442 .у 452
          событие = e2 .х 462 .у 534
            шлюз = g2 .х 555 .у 527 .х-закр 835 .у-закр 527
              ветка = +
                задача = t1 .ид Activity_18p4dw7 .тип отправка-сообщения .х 670 .у 512
                  связь = --> Activity_02342pj
              ветка = -
          событие = e3 .расположение конец .х 952 .у 534

        задача = t2 .тип сервис .х 1110 .у 512
          комментарий = c1 .х 1110 .у 440

      ветка = -

        задача = t3 .роль Роль 2 .х 310 .у 780
          событие = е6 .х 362 .у 842
          шлюз = g4 .х 355 .у 1021
            ветка = +
              задача = t6 .тип скрипт .х 460 .у 1006
                данные = d1 .х 492 .у 925
              задача = t8 .тип пользователь .х 620 .у 1006
                база-данных = b1 .х 645 .у 1275
              событие = e7 .расположение конец .х 1422 .у 1028
            ветка = -
              событие = e8 .расположение конец .х 1422 .у 1138

        событие = e5 .х 462 .у 802

        шлюз .тип параллельный .х 575 .у 795 .х-закр 895 .у-закр 795
          ветка = w1
            задача = t4 .тип получение-сообщения .повторение последовательно .х 710 .у 780
          ветка = w2
            задача = t5 .тип бизнес-правило .повторение цикл .х 710 .у 890

      событие .расположение конец .х 1392 .у 534

процесс = Процесс 2
  событие = e9 .х 592 .у 187
  задача = t7 .ид Activity_02342pj .х 680 .у 165
